...
For UI, copy, people, mobile layout, or code comments work, load the matching antislop skill before starting. Each skill is a folder in `.agents/skills/` (read its SKILL.md):
